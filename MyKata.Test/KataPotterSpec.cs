        ...
        public class when_basket_contains_mixed_books : concern
        {
            it should_handle_price_for_1_1_2 = () =>
            {
                new PotterBookBasket(
                    ...
                    ).CalculatePrice().should_be_equal_to(8 * 2 * 0.95 + 8);
            ...
            it should_handle_price_for_1_1_2_2 = () =>
            {
                new PotterBookBasket(
                    ...
                    ).CalculatePrice().should_be_equal_to(2 * (8 * 2 * 0.95));
            ...
            it should_handle_price_for_1_1_2_3_3_4 = () =>
            {
                new PotterBookBasket(
                    ...
                    ).CalculatePrice().should_be_equal_to((8 * 4 * 0.8) + (8 * 2 * 0.95));
            ...
            it should_handle_price_for_1_2_2_3_4_5 = () =>
            {
                new PotterBookBasket(
                    ...
                    ).CalculatePrice().should_be_equal_to(8 + (8 * 5 * 0.75));
            ...
            it should_handle_price_for_extreme_case_1 = () =>
            {
                new PotterBookBasket(
                    ...
                    ).CalculatePrice().should_be_equal_to(2*(8*4*0.8));
            };
            ...
            it should_handle_price_for_extreme_case_2 = () =>
            {
                new PotterBookBasket(
                    ...
                    ).CalculatePrice().should_be_equal_to(3 * (8 * 5 * 0.75) + 2 * (8 * 4 * 0.8));
            };
        }
    }
}